...
export const isStellarChangeTrustLinePrerequisite = (
  ...
  prerequisite.type === 'STELLAR_CHANGE_TRUSTLINE'
...
export type StellarChangeTrustLinePrerequisiteResult =
  BaseTransactionPrerequisiteResult<'STELLAR_CHANGE_TRUSTLINE'>
...
export const isStellarChangeTrustLinePrerequisiteResult = (
  ...
  prerequisiteResult.prerequisiteType === 'STELLAR_CHANGE_TRUSTLINE'
